...
> **Note**: Version 20.0.0 has been retracted from npm. 20.0.1 is the first available stable release for Angular 20.
...
## [20.0.0] - 2026-06-16 [RETRACTED]

> This version has been retracted from npm. Use 20.0.1 instead.

Port of 22.0.0 to Angular 20. No library source changes. Switched to `@angular-devkit/build-angular` builders and standalone vitest runner with `@analogjs/vite-plugin-angular`.
