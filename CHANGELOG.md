...
> **Note**: Version 19.0.0 has been retracted from npm. 19.0.1 is the first available stable release for Angular 19.
...
## [19.0.0] - 2026-06-16 [RETRACTED]

> This version has been retracted from npm. Use 19.0.1 instead.

Port of 22.0.0 to Angular 19. No library source changes. Uses `provideExperimentalZonelessChangeDetection`, `experimentalDecorators`, and `moduleResolution: "node"`.
